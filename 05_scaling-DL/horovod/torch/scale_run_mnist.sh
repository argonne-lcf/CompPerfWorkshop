...
for n in 1 2 4 8
do
    outfile=./results_mnist/torch_hvd_mnist_batch${BATCH_SIZE}_gpu${n}.log
    echo ${outfile}
    mpirun -np ${n} --verbose python3 ./torch_hvd_mnist.py --batch_size=$BATCH_SIZE --epochs=200 >& ${outfile}
